...
travail, cela n'empêche pas que le problème de fond vient de Microsoft qui est
...
C'est ainsi que j'ai résolu le problème. L'image originale est un `.DI` que m'a
