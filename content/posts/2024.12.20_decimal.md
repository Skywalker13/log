...
important de comprendre la moindre ce qui se passe dans la machinerie et
pourquoi le résultat de cette équation si trivial, n'est pas exacte.
...
infini. Mais cette explication n'est pas complète car ici on représente les
nombres en base 10 et pas en base 2. Prennons un exemple encore plus simple avec
un nombre sans partie périodique et demandons à nos langages de programmation ce
qu'il en est.
...
Un nombre à virgule flottant se calcul ainsi :
...
nombre `Fric` qui conservent l'historique des opérations. Cette petite
bibliothèque est (au moment où j'écris cet article) uniquement un PoC.
